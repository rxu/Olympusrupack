...
$lang = array_merge($lang, [
	...
	'ACP_MANAGE_ATTACHMENTS_EXPLAIN'	=> 'Здесь можно просматривать и удалять вложения, прикреплённые к сообщениям в темах и личным сообщениям.',

	'ACP_MANAGE_EXTENSIONS'		=> 'Управление расширениями файлов',
	...
	'CSV_INVALID'			=> 'Разделённый запятыми список «%1$s» имеет неверный формат. Разделителем значений в списке может быть только запятая, разделитель не может находиться в начале или в конце списка.',
	...
	'LOAD_NOTIFICATIONS_EXPLAIN'	=> 'Показывать список уведомлений на каждой странице (как правило, вверху).',
	...
	'NO_FILES_TO_DELETE'	=> 'Выбранные для удаления вложения не существуют.',
	...
	'RELEASE_ANNOUNCEMENT'				=> 'Объявление',
	'REMIND'							=> 'Напомнить',
	'REPARSE_LOCK_ERROR'				=> 'Обработка уже используется другим процессом.',
	...
	'URL_SCHEME_INVALID'	=> 'Имя протокола «%2$s» в настройке «%1$s» имеет неверный формат. Имя протокола должно начинаться с латинского символа и может содержать только латинские символы, цифры, дефисы и точки.',
...
// PHP info
$lang = array_merge($lang, [
	'ACP_PHP_INFO_EXPLAIN'	=> 'Эта страница отображает сведения о версии PHP, установленной на данном сервере. Она включает подробные сведения о загруженных модулях, доступных переменных и настройках по умолчанию. Данная информация может быть полезна при диагностировании различных неполадок. Некоторые хостинг-провайдеры ограничивают её отображение по соображениям безопасности. Не разглашайте никаких сведений с этой страницы никому, кроме членов команд <a href="https://www.phpbb.com/about/team/">официальной поддержки phpBB Group</a> или <a href="https://www.phpbbguru.net">официальной русской поддержки phpBB Guru</a>.',
...
$lang = array_merge($lang, [
	...
	'PURGE_CACHE_SUCCESS'	=> 'Кэш успешно очищен.',
	...
	'RESYNC_POSTCOUNTS_SUCCESS'			=> 'Счётчики сообщений успешно синхронизированы',
	...
	'RESYNC_POST_MARKING_SUCCESS'	=> 'Свои темы успешно синхронизированы',
	...
	'RESYNC_STATS_SUCCESS'			=> 'Статистика успешно синхронизирована',
	'RUN'							=> 'Выполнить',

	'STATISTIC'					=> 'Статистика',
	'STATISTIC_RESYNC_OPTIONS'	=> 'Синхронизация или сброс статистики',

	'TIMEZONE_INVALID'	=> 'Выбран неверный часовой пояс.',
	'TIMEZONE_SELECTED'	=> '(текущий)',
	...
	'WRITABLE_CONFIG'		=> 'Файл config.php в настоящее время доступен для записи. Настоятельно рекомендуется изменить право доступа к этому файлу на 640 или по крайней мере на 644 (например: <a href="https://ru.wikipedia.org/wiki/Chmod" rel="external">chmod</a> 640 config.php).',
]);
...
$lang = array_merge($lang, [
	...
	'LOG_ACL_ADD_MOD_LOCAL_M_'			=> '<strong>Добавлены или изменены модераторы</strong> для %1$s<br />» %2$s',
	'LOG_ACL_ADD_FORUM_LOCAL_F_'		=> '<strong>Добавлен или изменён доступ к форуму</strong> для %1$s<br />» %2$s',
	...
	'LOG_MOVED_TOPIC'			=> '<strong>Перемещена тема</strong><br />» %s',
	...
	'LOG_SPHINX_ERROR'			=> '<strong>Ошибка Sphinx</strong><br />В» %s',

	'LOG_SPAMHAUS_OPEN_RESOLVER'		=> 'Spamhaus не допускает запросы с использованием DNS серверов, работающих по принципу open resolver. Проверка была отключена. Дополнительная информация: https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
	'LOG_SPAMHAUS_VOLUME_LIMIT'			=> 'Превышен порог количества запросов к Spamhaus. Проверка была отключена. Дополнительная информация: https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
