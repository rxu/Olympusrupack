...
$lang = array_merge($lang, [
	...
	'DEFAULT_SEARCH_RETURN_CHARS'			=> 'Максимальное количество символов в сообщениях',
	'DEFAULT_SEARCH_RETURN_CHARS_EXPLAIN'	=> 'Количество символов, которым будет ограничен текст сообщений в результатах поиска. Введите 0 для вывода полного текста сообщений.',
