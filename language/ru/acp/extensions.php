...
$lang = array_merge($lang, array(
	...
	'EXTENSION_UPDATE_EXPLAIN'	=> '<ol>
			<li>Отключить расширения</li>
			<li>Удалить файлы от расширения из файловой системы</li>
			<li>Загрузить новые файлы</li>
			<li>Включить расширение</li>
		</ol>',
	'EXTENSION_REMOVE_HEADLINE'	=> 'Полное удаление расширения с Вашей конференции.',
	'EXTENSION_REMOVE_EXPLAIN'	=> '<ol>
			<li>Отключить расширения</li>
			<li>Удалить данные расширения</li>
			<li>Удалить файлы от расширения из файловой системы</li>
		</ol>',
