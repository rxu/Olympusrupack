...
$lang = array_merge($lang, [
	...
	'BBCODE_DANGER'				=> 'Добавляемый BBCode может создать проблемы с безопасностью. Если используется лексема {TEXT} в ненадежном контексте (например, тегах HTML или JavaScript), попробуйте вместо неё применить лексемы, использующие более строгие проверки. Нажимайте кнопку «Продолжить» только в случае, если польностью осознаёте все возможные риски.',
	...
	'BBCODE_INVALID'			=> 'BBCode содержит ошибки.',
	'BBCODE_INVALID_TEMPLATE'	=> 'Замена HTML содержит ошибки.',
	'BBCODE_TAG'				=> 'Тег',
	...
	'tokens'	=>	array(
		'TEXT'			=> 'Любой текст, включая символы любого языка, числа и так далее.',
