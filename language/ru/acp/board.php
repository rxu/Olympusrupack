...
$lang = array_merge($lang, array(
	...
	'BOARD_INDEX_TEXT'				=> 'Название списка форумов',
	'BOARD_INDEX_TEXT_EXPLAIN'		=> 'Этот текст будет отображен вместо списка форумов в меню навигации конференции. По умолчанию будет отображен текст “Список форумов”.',
...
$lang = array_merge($lang, array(
	...
	'COOKIE_SECURE_EXPLAIN'		=> 'Если ваш сервер работает через SSL, то включите этот параметр. В противном случае оставьте отключенным. Включение этого параметра, если сервер работает не через SSL, приведёт к ошибкам при переходах по страницам конференции и при переадресации.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_CDN'					=> 'Разрешить использование сторонней сети доставки контента',
	'ALLOW_CDN_EXPLAIN'				=> 'Если включено, некоторые файлы будут переданы через внешние сторонние серверы вместо вашего сервера. Это снизит пропускную способность вашего сервера, но может предоставить конфиденциальность для некоторых администраторов.',
	...
	'LOAD_JQUERY_CDN'				=> 'Использовать jQuery из библиотек Google CDN',
	'LOAD_JQUERY_CDN_EXPLAIN'		=> 'Если данная функция включена, будет использован jQuery из библиотек Google AJAX API CDN вместо локальной копии, входящей в пакет phpBB. В случае, если загрузить jQuery из библиотек CDN не удастся, phpBB попытается использовать указанную локальную копию.',
	...
	'READ_NOTIFICATION_EXPIRE_DAYS'	=> 'Длительность прочитанных уведомлений',
	'READ_NOTIFICATION_EXPIRE_DAYS_EXPLAIN' => 'Количество дней, по истечении которых прочитанные уведомления будут автоматически удалены. Установите 0, чтобы сделать уведомления бессрочными.',
...
$lang = array_merge($lang, array(
	...
	'MOD_REWRITE_ENABLE_EXPLAIN' => 'Если включено, URL содержащие ’app.php’ будут переписаны с удалением имени файла (т.е. app.php/foo станет /foo). <strong>Для корректной работы требуется модуль Apache mod_rewrite; если эта опция включена без поддержки mod_rewrite, URL на вашей конференции могут быть недоступны.</strong>',
	'MOD_REWRITE_DISABLED'		=> 'Модуль <strong>mod_rewrite</strong> на вашем Apache сервере отключен. Включите модуль или свяжитесь с вашим поставщиком услуг хостинга если вы хотите включить эту функцию.',
	'MOD_REWRITE_INFORMATION_UNAVAILABLE' => 'Невозможно определить, поддерживает ли сервер URL rewriting или нет. Эта опция может быть включена, но если URL rewriting недоступна, пути созданые конференцией (sкоторый будут использованы для ссылок) могут быть недоступны. Свяжитесь с вашим поставщиком услуг хостинга, если вы не уверены, действительно ли можете спокойно включить эту функцию.',
...
$lang = array_merge($lang, array(
	...
	'ALL'							=> 'Полная',
	'ALLOW_AUTOLOGIN'				=> 'Разрешить функцию «Запомнить меня»',
	'ALLOW_AUTOLOGIN_EXPLAIN'		=> 'Опция определяет, разрешена ли пользователям функция «Запомнить меня»  при посещении конференции.',
