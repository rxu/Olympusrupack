...
$lang = array_merge($lang, [
	...
	'BOARD_INDEX_TEXT_EXPLAIN'		=> 'Этот текст отображается как ссылка на главную страницу конференции в меню навигации. По умолчанию будет отображен текст «Список форумов».',
	...
	'DISABLE_BOARD_EXPLAIN'			=> 'Конференция станет недоступной для пользователей, не являющихся администраторами или модераторами. Также вы можете ввести короткое сообщение (до 255 символов), которое будут видеть посетители.',
	'DISPLAY_LAST_SUBJECT'			=> 'Показывать заголовок последнего сообщения в списке форумов',
	'DISPLAY_LAST_SUBJECT_EXPLAIN'	=> 'Заголовок последнего сообщения будет отображен в списке форумов в виде ссылки на данное сообщение. Заголовки сообщений, оставленных в форумах, защищённых паролем, либо право доступа к чтению которых у пользователя отсутствует, не будут показаны.',
	'DISPLAY_UNAPPROVED_POSTS'		=> 'Показывать авторам их сообщения, ожидающие одобрения',
	'DISPLAY_UNAPPROVED_POSTS_EXPLAIN'	=> 'Авторы смогут видеть свои сообщения, находящиеся в очереди на модерацию (одобрение). Не относится к сообщениям гостей.',
	'GUEST_STYLE'					=> 'Стиль для гостей',
	'GUEST_STYLE_EXPLAIN'			=> 'Стиль конференции для незарегистрированных пользователей.',
	'OVERRIDE_STYLE'				=> 'Заменять стиль пользователя',
	'OVERRIDE_STYLE_EXPLAIN'		=> 'Стиль, выбранный пользователем или гостем, будет заменён стилем, указанным в настройке «Стиль конференции по умолчанию».',
	'SITE_DESC'						=> 'Описание конференции',
	'SITE_HOME_TEXT'				=> 'Название основного сайта',
	'SITE_HOME_TEXT_EXPLAIN'		=> 'Этот текст будет отображён в виде ссылки на основной сайт в меню навигации конференции. По умолчанию будет отображен текст «На главную».',
	'SITE_HOME_URL'					=> 'Ссылка на основной сайт',
	'SITE_HOME_URL_EXPLAIN'			=> 'Если задано, данная ссылка будет добавлена в начало меню навигации конференции, а также к логотипу конференции. Ссылка должна быть абсолютной, например <samp>https://www.phpbbguru.net</samp>.',
...
$lang = array_merge($lang, [
	...
	'ALLOW_GRAVATAR'				=> 'Разрешить глобально распознаваемые аватары (Gravatar)',
	'ALLOW_LOCAL'					=> 'Разрешить галерею аватар',
	'ALLOW_REMOTE'					=> 'Разрешить удалённые аватары',
	'ALLOW_REMOTE_EXPLAIN'			=> 'Ссылки на аватары, отображаемые с других сайтов.<br><em><strong class="error">Внимание:</strong> Включение данной функции может позволить пользователям производить проверку на существование файлов и сервисов в локальной сети.</em>',
	'ALLOW_REMOTE_UPLOAD'			=> 'Разрешить удалённую загрузку аватар',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> 'Разрешить загрузку аватар с других сайтов.<br><em><strong class="error">Внимание:</strong> включение данной функции может позволить пользователям производить проверку на существование файлов и сервисов в локальной сети.</em>',
	'ALLOW_UPLOAD'					=> 'Разрешить прямую загрузку аватар',
	'AVATAR_GALLERY_PATH'			=> 'Путь к галерее аватар',
	'AVATAR_GALLERY_PATH_EXPLAIN'	=> 'Путь к папке с загруженными в неё рисунками относительно корневой папки phpBB. Например, <samp>images/avatars/gallery</samp>.<br>Сдвоенные точки <samp>../</samp> будут удалены из пути в целях безопасности.',
	'AVATAR_STORAGE_PATH'			=> 'Папка для загрузки аватар',
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'Путь к папке относительно корневой папки phpBB. Например, <samp>images/avatars/upload</samp>.<br>Загрузка аватар <strong>будет недоступна</strong>, если для данной директории отсутствуют права на запись.<br />Сдвоенные точки <samp>../</samp> будут удалены из пути в целях безопасности.',
...
$lang = array_merge($lang, [
	...
	'ALLOWED_SCHEMES_LINKS'				=> 'Разрешённые протоколы в ссылках',
	'ALLOWED_SCHEMES_LINKS_EXPLAIN'		=> 'Пользователи смогут размещать в сообщениях ссылки только с протоколами, указанными в данном списке через запятую. В противном случае, можно будет размещать только ссылки без указания протокола.',
	...
	'MAX_POST_IMG_HEIGHT'			=> 'Максимальная высота flash в сообщении',
	'MAX_POST_IMG_HEIGHT_EXPLAIN'	=> 'Максимальная высота flash в сообщениях. Введите 0 для снятия ограничений.',
	'MAX_POST_IMG_WIDTH'			=> 'Максимальная ширина flash в сообщении',
	'MAX_POST_IMG_WIDTH_EXPLAIN'	=> 'Максимальная ширина flash в сообщениях. Введите 0 для снятия ограничений.',
...
$lang = array_merge($lang, [
	...
	'ACC_ACTIVATION_EXPLAIN'			=> 'Эта группа настроек определяет, могут ли пользователи иметь доступ к конференции сразу после регистрации или для этого требуется подтверждение регистрации. Также здесь можно полностью отключить регистрацию новых пользователей. <em>Функция «Разрешить email-сообщения» должна быть включена для использования возможности активации новых учётных записей пользователем или администратором.</em>',
	'ACC_ACTIVATION_WARNING'			=> 'Учтите, что текущий метод активации новых пользователей требует включения email-сообщений на конференции, в противном случае регистрация будет недоступна. Рекомендуется выбрать другой метод активации или разрешить email-сообщения.',
...
//	'ACC_USER_ADMIN'			=> 'User + Admin',
	...
	'PASSWORD_LENGTH_EXPLAIN'	=> 'Минимальное количество символов в паролях. Учтите, что максимальное количество не ограничено.',
...
$lang = array_merge($lang, [
	...
	'ACP_FEED_ENABLE_EXPLAIN'			=> 'Включение или отключение каналов новостей для всей конференции.<br>При отключении этой опции будут отключены все каналы новостей, независимо от указанных ниже параметров.',
	...
	'ACP_FEED_OVERALL_FORUMS_EXPLAIN'	=> 'Включает канал «Все форумы», который позволяет получить список форумов.',
 	...
 	'ACP_FEED_HTTP_AUTH_EXPLAIN'		=> 'Включает аутентификацию через HTTP, которая позволяет пользователям получать доступ к информации, недоступной для гостей, путём добавления параметра <samp>auth=http</samp> в адресную строку канала новостей. Учтите, что для работы данной функции на некоторых серверах может потребоваться внесение дополнительных изменений в файл .htaccess. HTTP-аутентификация поддерживается только для сайтов с защищённым подключением (https).',
	'ACP_FEED_ITEM_STATISTICS'			=> 'Статистика элементов',
	'ACP_FEED_ITEM_STATISTICS_EXPLAIN'	=> 'Отображение индивидуальной статистики под элементами канала<br>(такой, как автор сообщения, дата и время публикации, количество ответов и просмотров).',
	'ACP_FEED_EXCLUDE_ID'				=> 'Исключить данные форумы',
	'ACP_FEED_EXCLUDE_ID_EXPLAIN'		=> 'Содержимое следующих форумов не будет включено в каналы новостей. Не выбирайте ничего, если хотите получать данные со всех форумов.<br>Чтобы выбрать несколько форумов, пользуйтесь мышью, удерживая кнопку <samp>CTRL</samp>.',
]);
...
$lang = array_merge($lang, [
	...
	'ACP_VC_EXT_GET_MORE'					=> 'За дополнительными (и, возможно, более эффективными) антиспам-модулями обратитесь к <a href="https://www.phpbb.com/go/anti-spam-ext"><strong>Базе данных расширений phpBB.com</strong></a>. Дополнительную информацию о предотвращении спама на конференции можно найти в <a href="https://www.phpbb.com/go/anti-spam"><strong>Базе знаний phpBB.com</strong></a>.',
...
// Cookie Settings
$lang = array_merge($lang, [
	'ACP_COOKIE_SETTINGS_EXPLAIN'	=> 'Здесь вы можете изменить настройки cookies, отправляемые в браузеры посетителей. В большинстве случаев достаточно настроек по умолчанию. Если вам всё же нужно изменить настройки, то делайте это осторожно — неверные значения могут привести к невозможности входа пользователей на конференцию. Если такие проблемы возникли, посетите страницу <strong><a href="https://www.phpbb.com/support/go/cookie-settings/">База Знаний phpBB.com - исправление настроек cookie</a></strong>, или обратитесь за помощью на сайт официальной русской поддержки <strong><a href="https://www.phpbbguru.net/community/">phpBB Guru</a></strong>.',

	'COOKIE_DOMAIN'					=> 'Домен cookie',
	'COOKIE_DOMAIN_EXPLAIN'			=> 'В большинстве случаев нет необходимости указывать домен cookie. Оставьте поле пустым, если не уверены, какое значение нужно задать.<br><br> Если конференция интегрирована с другим программным обеспечением или используется несколько доменов, настройте домен cookie следующим образом. Например, если имена доменов выглядят как <i>example.com</i> и <i>forums.example.com</i>, или <i>forums.example.com</i> и <i>blog.example.com</i>, используется имя общего для них домена <i>example.com</i>, перед которым добавляется точка. В итоге, задаваемое имя домена cookie будет выглядеть как <i>.example.com</i> (обратите внимание на точку в начале).',
	'COOKIE_NAME'					=> 'Имя cookie',
	'COOKIE_NAME_EXPLAIN'			=> 'Имя cookie может быть любым, как можно более уникальным. При изменении настроек cookie необходимо также изменить его имя.',
	'COOKIE_NOTICE'					=> 'Предупреждение об использовании cookie',
	'COOKIE_NOTICE_EXPLAIN'			=> 'Если включено, пользователям будет отображаться предупреждение об использовании cookie на конференции. Данное предупреждение может быть необходимо в случаях, если законодательство требует этого, в зависимости от тематики конференции и установленных расширений.',
	'COOKIE_PATH'					=> 'Путь cookie',
	'COOKIE_PATH_EXPLAIN'			=> 'Путь cookie обычно представляет собой путь к конференции, или просто прямой слэш, чтобы сделать cookie доступным для всех страниц домена.',
	...
	'SESSION_GC'					=> 'Периодичность очистки сессий',
	'SESSION_GC_EXPLAIN'			=> 'Очистка сессий будет производиться с указанной периодичностью в секундах.',
	'SESSION_GUEST_LENGTH'			=> 'Длительность гостевой сессии',
	'SESSION_GUEST_LENGTH_EXPLAIN'	=> 'Гостевая сессия будет завершена по прошествии указанного времени в секундах.',
	'SESSION_GUEST_GC'				=> 'Периодичность очистки гостевых сессий',
	'SESSION_GUEST_GC_EXPLAIN'		=> 'Очистка гостевых сессий будет производиться с указанной периодичностью в секундах.',
]);

// Contact Settings
$lang = array_merge($lang, [
	'ACP_CONTACT_SETTINGS_EXPLAIN'		=> 'Здесь можно включить или отключить страницу для связи с администрацией, а также добавить текст, отображаемый на данной странице.',

	'CONTACT_US_ENABLE'				=> 'Включить страницу для связи с администрацией',
	'CONTACT_US_ENABLE_EXPLAIN'		=> 'Данная страница позволяет пользователям отправлять электронную почту администраторам конференции. Учтите, что для этого должна быть включена настройка «Разрешить email-сообщения», которую можно найти в разделе Общие &gt; Средства связи &gt; Настройки почты.',

	'CONTACT_US_INFO'				=> 'Контактная информация',
	'CONTACT_US_INFO_EXPLAIN'		=> 'Сообщение, отображаемое на странице для связи с администрацией',
	'CONTACT_US_INFO_PREVIEW'		=> 'Страница для связи с администрацией - Предпросмотр',
	'CONTACT_US_INFO_UPDATED'		=> 'Информация страницы для связи с администрацией обновлена.',
]);
...
$lang = array_merge($lang, [
	...
	'ALLOW_CDN_EXPLAIN'				=> 'Если включено, некоторые служебные файлы конференции будут загружаться пользователями из сетей доставки контента (CDN) вместо вашего сервера. Это уменьшит расход траффика вашего сервера, но может вызвать проблемы, связанные с сохранением конфиденциальности данных, в некоторых странах. По умолчанию, включена загрузка «jQuery» и шрифта «Open Sans» из сети доставки контента Google. Это также относится к шрифту «Font Awesome», используемому phpBB и некоторыми расширениями для отображения значков.',
	'ALLOW_LIVE_SEARCHES'			=> 'Разрешить поиск «на лету»',
	'ALLOW_LIVE_SEARCHES_EXPLAIN'	=> 'Если разрешено, пользователям будут предлагаться варианты результатов поиска по мере набора ключевых слов в некоторых поисковых полях на конференции.',
	...
	'LOAD_USER_ACTIVITY_LIMIT_EXPLAIN'	=> 'Темы и форумы, в которых пользователь наиболее активен, не будут отображены для пользователей, имеющих количество сообщений больше указанного. Установите 0 для снятия ограничения.',
	'READ_NOTIFICATION_EXPIRE_DAYS'	=> 'Срок действия прочитанного уведомления',
	'READ_NOTIFICATION_EXPIRE_DAYS_EXPLAIN' => 'Количество дней, по истечению которых прочитанное уведомление будет автоматически удалено. Установите 0, чтобы прочитанные уведомления не удалялись.',
	...
	'YES_ACCURATE_PM_BUTTON'			=> 'Включить проверку прав доступа для отображения кнопки личного сообщения на страницах тем',
	'YES_ACCURATE_PM_BUTTON_EXPLAIN'	=> 'Если включено, то кнопка личного сообщения в минипрофилях на страницах тем будет отображаться только для пользователей, имеющих право получать личные сообщения.',
...
// Auth settings
$lang = array_merge($lang, [
	'ACP_AUTH_SETTINGS_EXPLAIN'	=> 'phpBB поддерживает расширения аутентификации, или модули. Они позволяют вам установить способ аутентификации пользователей при их входе на конференцию. По умолчанию доступны четыре модуля: DB, LDAP, Apache и OAuth. Не все методы требуют дополнительной информации, поэтому заполняйте только те поля, которые необходимы для выбранного метода.',

	'AUTH_METHOD'				=> 'Выбрать метод аутентификации',

	'AUTH_PROVIDER_OAUTH_ERROR_ELEMENT_MISSING'	=> 'Для каждого провайдера сервиса OAuth должны быть указаны и ключ (key), и секретный код (secret). Указывайте только те, которые получены от соответствующего провайдера сервиса OAuth.',
	'AUTH_PROVIDER_OAUTH_EXPLAIN'				=> 'Каждый провайдер OAuth требует уникальную пару секретного кода и ключа для аутентификации с помощью внешнего сервера. Они должны быть предоставлены провайдером и ведены в точности в том виде, в котором были получены.<br>Любой сервис, не предоставляющий одновременно и ключ, и секретный код, будет недоступен для аутентификации пользователей конференции. Учтите, что пользователь всё равно сможет зарегистрироваться и войти на конференцию через стандартный метод аутентификации (DB).',
	'AUTH_PROVIDER_OAUTH_KEY'					=> 'Ключ',
	'AUTH_PROVIDER_OAUTH_TITLE'					=> 'OAuth',
	'AUTH_PROVIDER_OAUTH_SECRET'				=> 'Секретный код',
...
$lang = array_merge($lang, [
	...
	'MOD_REWRITE_ENABLE'		=> 'Включить URL Rewriting',
	'MOD_REWRITE_ENABLE_EXPLAIN'	=> 'Если включено, адреса URL, содержащие ’app.php’, будут изменены так, чтобы в них не значилось имя исполняемого файла (например: app.php/foo будет выглядеть как /foo). <strong>Для работы данной функции требуется включить модуль mod_rewrite сервера Apache (или аналогичный ему модуль другого сервера); если она включена в отсутствие модуля mod_rewrite, адреса URL на конференции могут работать некорректно.</strong>',
	'MOD_REWRITE_DISABLED'		=> 'Модуль <strong>mod_rewrite</strong> веб-сервера Apache отключён. Включите модуль, или свяжитесь с провайдером веб-хостинга для того, чтобы использовать данную функцию.',
	'MOD_REWRITE_INFORMATION_UNAVAILABLE' => 'Невозможно определить, поддерживается ли URL rewriting данным сервером. Данная функция может быть включена, однако, если URL rewriting не поддерживается, адреса на конференции (такие, как ссылки) могут отображаться неверно. Свяжитесь с провайдером веб-хостинга, если не уверены в том, безопасно ли включение данной функции.',
	...
	'SERVER_NAME_EXPLAIN'		=> 'Имя домена, на котором работает конференция. Например, <samp>example.com</samp>.',
	...
	'USE_SYSTEM_CRON'			=> 'Выполнять периодические задачи через планировщик (cron) операционной системы',
	'USE_SYSTEM_CRON_EXPLAIN'	=> 'Если отключено, phpBB будет выполнять периодические задачи автоматически. Если включено, phpBB не будет самостоятельно выполнять периодические задачи; вместо этого, системный администратор должен добавить выполнение <code>bin/phpbbcli.php cron:run</code> в планировщик (cron) операционной системы для запуска с определённым интервалом (например, каждые 5 минут).',
]);
...
$lang = array_merge($lang, [
	...
	'ALL'							=> 'Полная',
	'ALLOW_AUTOLOGIN'				=> 'Включить функцию «Запомнить меня»',
	'ALLOW_AUTOLOGIN_EXPLAIN'		=> 'Опция определяет, разрешено ли пользователям использовать функцию «Запомнить меня» при посещении конференции.',
	'ALLOW_PASSWORD_RESET'			=> 'Разрешить восстановление пароля («Забытый пароль»)',
	'ALLOW_PASSWORD_RESET_EXPLAIN'	=> 'Определяет, могут ли пользователи конференции использовать ссылку «Забыли пароль?» на странице входа для восстановления доступа к своему аккаунту. Если используется внешний механизм аутентификации, может понадобиться отключить данную функцию.',
	'AUTOLOGIN_LENGTH'				=> 'Время действия автоматического входа при использовании функции «Запомнить меня» (дней)',
	'AUTOLOGIN_LENGTH_EXPLAIN'		=> 'Количество дней, по прошествии которых пользователь должен будет снова ввести свои имя и пароль для входа на конференцию, при использовании функции «Запомнить меня». Введите 0 для снятия ограничений.',
	...
	'CHECK_DNSBL'					=> 'Проверять IP-адрес по чёрному списку DNS (DNS Blackhole List)',
	...
	'CLASS_B'						=> 'A.B',
	'CLASS_C'						=> 'A.B.C',
	'EMAIL_CHECK_MX'				=> 'Проверять правильность почтовой записи в DNS (MX Record) домена email-адреса',
	...
	'REFERRER_VALID'				=> 'Проверять рефёрер',
	'REFERRER_VALID_EXPLAIN'		=> 'Если включено, рефёрер для запросов типа POST будет проверен на параметры хоста/пути к скрипту. Это может вызвать проблемы с конференциями, использующими несколько доменов или внешние аутентификации.',
	...
	'UPLOAD_CERT_VALID'				=> 'Проверять сертификат загрузки',
	'UPLOAD_CERT_VALID_EXPLAIN'		=> 'Если включено, сертификаты удалённых загрузок будут подвергаться проверке. Для этого необходимо определить встроенную библиотеку CA в параметрах <samp>openssl.cafile</samp> или <samp>curl.cainfo</samp> в файле php.ini.',
]);
...
$lang = array_merge($lang, [
	...
	'ADMIN_EMAIL'					=> 'Адрес отправителя email',
	'ADMIN_EMAIL_EXPLAIN'			=> 'Этот адрес будет использован как адрес отправителя всех email-сообщений для технических контактов. Он всегда будет использоваться в поле <samp>Sender</samp> в email-сообщений.',
	...
	'CONTACT_EMAIL_NAME'			=> 'Имя контакта',
	'CONTACT_EMAIL_NAME_EXPLAIN'	=> 'Имя, которое будет отображено получателям email-сообщения. Оставьте поле пустым, если не желаете задавать данный параметр.',
	'EMAIL_FORCE_SENDER'			=> 'Принудительно использовать адрес отправителя',
	'EMAIL_FORCE_SENDER_EXPLAIN'	=> 'Принудительно использовать поле <samp>Return-Path</samp> в качестве адреса отправителя email-сообщений вместо использования имён пользователя и сервера. Эта настройка не оказывает влияния при отправке сообщений с помощью SMTP сервера.<br><em><strong>Внимание:</strong> Требуется добавление имени пользователя, под которым работает вебсервер, в список доверенных в конфигурации sendmail.</em>',
	...
	'EMAIL_MAX_CHUNK_SIZE'			=> 'Максимальное число получателей',
	'EMAIL_MAX_CHUNK_SIZE_EXPLAIN'	=> 'Максимальное количество адресатов в одном сообщении. Данная настройка применяется для того, чтобы не превысить значение, максимально разрешённое сервером.',
	...
	'ENABLE_EMAIL'					=> 'Разрешить email-сообщения',
	'ENABLE_EMAIL_EXPLAIN'			=> 'Если отключено, отправка любых электронных сообщений с конференции производиться не будет. <em>Примечание: данная опция должна быть включена, если вы хотите задействовать активацию учётной записи администратором или пользователем. Если в настоящий момент выбран метод активации новых учётных записей «Администратором» или «Пользователем», отключение данной опции сделает недоступной регистрацию новых пользователей.</em>',
	...
	'SMTP_ALLOW_SELF_SIGNED_EXPLAIN'=> 'Разрешить подключение к почтовым серверам SMTP с самоподписанными SSL сертификатами.<br><em><strong>Внимание:</strong> такое подключение может иметь негативные последствия с точки зрения информационной безопасности.</em>',
	...
	'SMTP_SERVER_EXPLAIN'			=> 'Не указывайте протокол (например, <samp>ssl://</samp> или <samp>tls://</samp>), если этого специально не требует сервер SMTP.',
	...
	'SMTP_VERIFY_PEER_EXPLAIN'		=> 'Требовать проверки SSL сертификата, используемого сервером SMTP.<br><em><strong>Внимание:</strong> подключение к ресурсам с непроверенными SSL сертификатами может иметь негативные последствия с точки зрения информационной безопасности.</em>',
	'SMTP_VERIFY_PEER_NAME'			=> 'Проверка имени узла SMTP',
	'SMTP_VERIFY_PEER_NAME_EXPLAIN'	=> 'Требовать проверки имени узла для серверов SMTP, использующих подключения SSL / TLS.<br><em><strong>Внимание:</strong> подключение к непроверенным узлам может иметь негативные последствия с точки зрения информационной безопасности.</em>',
	'TEST_EMAIL_SENT'				=> 'Тестовое email-сообщение отправлено.<br>Если вы не получили тестовое email-сообщение, проверьте настройки почты.<br><br>Для получения помощи, обратитесь на форумы <a href="https://www.phpbbguru.net/community/">официальной русской поддержки phpBB</a>.',
...
$lang = array_merge($lang, [
	...
	'JAB_ALLOW_SELF_SIGNED_EXPLAIN'	=> 'Разрешить подключение к серверам Jabber с самоподписанными SSL сертификатами.<br><em><strong>Внимание:</strong> такое подключение может иметь негативные последствия с точки зрения информационной безопасности.</em>',
	...
	'JAB_VERIFY_PEER_EXPLAIN'		=> 'Требовать проверки SSL сертификата, используемого сервером Jabber.<br><em><strong>Внимание:</strong> подключение к ресурсам с непроверенными SSL сертификатами может иметь негативные последствия с точки зрения информационной безопасности.</em>',
	'JAB_VERIFY_PEER_NAME'			=> 'Проверка имени узла Jabber',
	'JAB_VERIFY_PEER_NAME_EXPLAIN'	=> 'Требовать проверки имени узла для серверов Jabber, использующих подключения SSL / TLS.<br><em><strong>Внимание:</strong> подключение к непроверенным узлам может иметь негативные последствия с точки зрения информационной безопасности.</em>',
]);
