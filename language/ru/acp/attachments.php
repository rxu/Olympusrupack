...
$lang = array_merge($lang, [
	...
	'IMAGE_QUALITY'				=> 'Качество загружаемых изображений (только для JPEG)',
	'IMAGE_QUALITY_EXPLAIN'		=> 'Указывается значение между 50% (меньший размер готового файла) и 90% (лучшее качество). Качество выше 90% увеличивает размер готового файла и поэтому отключено. Данная настройка действует только в случае, если установлены максимальные размеры рисунков, отличные от 0 x 0 пикс.',
	'IMAGE_STRIP_METADATA'		=> 'Удалять метаданные изображения (только для JPEG)',
	'IMAGE_STRIP_METADATA_EXPLAIN'	=> 'Удалять метаданные Exif, такие как имя автора, координаты GPS и параметры съёмки. Настройка действует только в случае, если установлены максимальные размеры рисунков, отличные от 0 x 0 пикс.',
	...
	'MAX_IMAGE_SIZE_EXPLAIN'		=> 'Максимальные размеры загружаемых рисунков. phpBB может автоматически уменьшать размеры рисунка до указанных перед их загрузкой на конференцию.Введите 0×0 для отключения проверки размеров и их автоматического уменьшения.',
	...
	'NO_EXT_GROUP'				=> 'Нет',
	'NO_EXT_GROUP_ALLOWED_PM'	=> 'Отсутствуют <a href="%s">разрешённые группы расширений</a> для личных сообщений.',
	'NO_EXT_GROUP_ALLOWED_POST'	=> 'Отсутствуют <a href="%s">разрешённые группы расширений</a> для сообщений.',
	...
	'UPLOAD_POST_NOT_EXIST'			=> 'Невозможно загрузить файл «%1$s» в сообщение под номером %2$d. Данное сообщение не существует.',
]);
