...
$help = array(
	...
	array(
		...
		1 => 'Это программное обеспечение было создано и лицензировано phpBB Group. Если вы считаете, что какая-то функция должна быть добавлена, посетите <a href="https://www.phpbb.com/ideas/">Центр идей phpBB</a>, где можно отдать свой голос за уже поданные идеи или предложить собственные.'
	),
	array(
		0 => 'С кем можно связаться по вопросу некорректного использования и/или юридических вопросов, связанных с этой конференцией?',
		1 => 'Вы можете связаться с любым из администраторов, перечисленных в списке на странице «Наша команда». Если вы не получили ответа, свяжитесь с владельцем домена (сделайте <a href="https://www.google.com/search?q=whois">whois lookup</a>) или, если конференция находится на бесплатном домене (например, chat.ru, Yahoo!, free.fr, f2s.com и т. п.), с руководством или техподдержкой данного домена. Учтите, что phpBB Group <strong>не имеет никакого контроля над данной конференцией</strong> и не может нести никакой ответственности за то, кем и как данная конференция используется. Не обращайтесь к phpBB Group по юридическим вопросам (о приостановке работы конференции, ответственности за неё и т. д.), которые <strong>не относятся напрямую</strong> к сайту phpBB.com или которые частично относятся к программному обеспечению phpBB Group. Если же вы всё-таки пошлёте email в адрес phpBB Group об использовании данной конференции <strong>третьей стороной</strong>, то не ждите подробного письма, или вы можете вообще не получить ответа.'
	)
);
