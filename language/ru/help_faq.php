...
$help = array(
	...
	array(
		...
		1 => 'Это программное обеспечение было создано и лицензировано phpBB Group. Если вы считаете, что какая-то функция должна быть добавлена, посетите <a href="https://www.phpbb.com/ideas/">phpBB Ideas Centre</a>, где вы можете увидеть существующие идеи или предложить свои.'
	),
	array(
