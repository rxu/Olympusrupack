...
$lang = array_merge($lang, array(
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Вы успешно сконвертировали вашу конференцию в формат phpBB 3.1. Вы можете <a href="../">войти на конференцию</a>. Убедитесь, что все настройки успешно перенесены, прежде чем запустите конференцию, удалив папку install. Помните, что вспомогательную информацию по использованию phpBB можно получить в интернете, изучив <a href="https://www.phpbb.com/support/docs/en/3.1/ug/">документацию</a>, а также на <a href="https://www.phpbb.com/phpBB/viewforum.php?f=466">форуме поддержки phpBB Group</a> и форумах официальной русской поддержки <a href="http://www.phpbbguru.net">phpBB Guru</a>.',
	...
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		Вы успешно установили phpBB %1$s. Теперь вы можете решить, что делать дальше с только что установленным phpBB3:</p>
		...
		<p>Нажав на кнопку ниже, вы попадёте на страницу отправки статистических данных phpBB в администраторском разделе. Мы будем вам очень признательны, если вы поможете нам, отправив немного статистической информации о вашем сервере и конфигурации phpBB. На основе этой информации мы будем принимать решения о функциональности будущего phpBB. Затем ознакомьтесь с имеющимися пунктами меню и настройками администраторского раздела. Освоение имеющихся возможностей phpBB3 может занять некоторое время. Помните о доступной в интернете <a href="https://www.phpbb.com/support/docs/en/3.1/ug/">документации</a>, <a href="%3$s">встроенном файле README</a> и <a href="https://www.phpbb.com/community/viewforum.php?f=466">форуме поддержки</a> (на английском), а также форумах официальной русскоязычной поддержки <a href="http://www.phpbbguru.net">phpBB Guru</a>.</p><p><strong>Удалите, переместите или переименуйте папку «install» перед использованием конференции. В противном случае будет доступен только администраторский раздел.</strong>',
	...
	'PHP_JSON_SUPPORT_EXPLAIN'		=> '<strong>Необходима</strong>. Для правильной работы phpBB необходимо наличие расширения PHP JSON.',
	...
	'PHP_SETTINGS_EXPLAIN'			=> 'Для установки phpBB <strong>требуется</strong> версия PHP не ниже 5.3.3 (PHP 7 и выше не поддерживается). Если ниже написано <var>Безопасный режим (Safe mode)</var>, то PHP работает в этом режиме. Это наложит некоторые ограничения на удалённое администрирование и аналогичные функции.',
	...
	'PHP_VERSION_REQD'				=> 'Версия PHP ≥ 5.3.3, < 7.0.0-dev',
	...
	'SELECT_FORUM_GA'			=> 'В phpBB 3.1 важные темы привязаны к форумам. Выберите форум для данной важной темы (тема может быть перенесена в другой форум позже):',
	...
	'STAGE_CREATE_TABLE_EXPLAIN'	=> 'Таблицы базы данных phpBB 3.1 созданы и заполнены начальными данными. Перейдите к следующему этапу для завершения установки phpBB.',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Все файлы соответствуют самой последней версии phpBB.',
	...
	'DATABASE_UPDATE_COMPLETE'			=> 'База данных обновлена!',
	'DATABASE_UPDATE_CONTINUE'			=> 'Продолжить обновление базы данных',
	...
	'DATABASE_UPDATE_NOT_COMPLETED'		=> 'Обновление базы данных ещё не завершено.',
	...
	'DOWNLOAD_UPDATE_METHOD_EXPLAIN'	=> 'Скачав архив, распакуйте его. В нём вы найдёте изменённые файлы, которые нужно закачать в корень phpBB, при этом каждый файл должен оказаться в соответствующей ему папке. После этого снова проведите сравнение файлов, нажав отвечающую за это кнопку ниже.',

	'EDIT_USERNAME'	=> 'Изменить имя пользователя',
	'ERROR'			=> 'Ошибка',
	'EVERYTHING_UP_TO_DATE'    => 'Всё обновлено до самой последней версии phpBB. Теперь <a href="%1$s">войдите на конференцию</a> и проверьте, что всё работает нормально. Не забудьте удалить, переименовать или переместить папку «install»! Пожалуйста, отправьте нам обновлённую информацию о вашем сервере и конфигурации конференции с помощью страницы <a href="%2$s">Статистические данные</a> в администраторском разделе.',
	...
	'FILES_DELETED_EXPLAIN'			=> 'Следующие файлы не существуют в новой версии. Данные файлы должны быть удалены.',
	...
	'NO_UPDATE_FILES_OUTDATED'		=> 'Не найдена папка с обновлениями. Убедитесь, что вы закачали соответствующие файлы на сервер.<br /><br />Ваша версия phpBB %1$s <strong>не</strong> самая последняя, для неё доступны обновления. Зайдите на страницу <a href="https://www.phpbb.com/downloads/" rel="external">https://www.phpbb.com/downloads/</a>, чтобы скачать нужный вам пакет обновления с версии %2$s до версии %3$s.',
	...
	'PACKAGE_VERSION'					=> 'Текущая версия',
	...
	'SHOW_DIFF_DELETED'			=> 'Показать содержимое файла',
	...
	'SQL'						=> 'SQL-запрос',
	'SQL_FAILURE_EXPLAIN'		=> 'Скорее всего, волноваться не о чем, процесс обновления будет продолжен. Если он не будет завершён, то поищите справку на наших форумах поддержки. Для получения сведений о поддержке смотрите файл <a href="../docs/README.html">README</a>.',
	...
	'UPDATE_INCOMPLETE_EXPLAIN'		=> '<h1>Незавершённое обновление</h1>
		...
		<p>Обнаружена неудачная попытка обновления. Запустите <a href="%1$s" title="%1$s">программу обновления базы данных</a>. Если она отсутствует на сервере, скачайте <a href="https://www.phpbb.com/downloads/" title="phpBB downloads">установочный пакет обновлённой версии</a>, загрузите на сервер папку «install» (туда же, где расположен файл config.php) и запустите <a href="%1$s" title="%1$s">программу обновления базы данных</a>.</p>',
	...
	'UPDATE_FILE_SUCCESS'			=> 'Файлы успешно обновлены.',
