...
$lang = array_merge($lang, [
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>Пакет автоматического обновления используется только в тех случаях, когда имеются модифицированные вручную файлы ядра phpBB. Вы также можете произвести обновление, используя методы, указанные в документе INSTALL.html. Для использования пакета автоматического обновления нужно выполнить следующие шаги:</p>

		<ol style="margin-left: 20px; font-size: 1.1em;">
			<li>Перейти на <a href="https://www.phpbb.com/downloads/" title="https://www.phpbb.com/downloads/">страницу загрузки phpBB.com</a> и скачать архив с пакетом автоматического обновления («Automatic Update Package»).</li>
			<li>Распаковать архив.</li>
