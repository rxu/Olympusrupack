...
$lang = array_merge($lang, array(
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Вы успешно сконвертировали вашу конференцию в формат phpBB 3.1. Вы можете <a href="../">войти на конференцию</a>. Убедитесь, что все настройки успешно перенесены, прежде чем запустите конференцию, удалив папку install. Помните, что вспомогательную информацию по использованию phpBB можно получить в интернете, изучив <a href="https://www.phpbb.com/support/documentation/3.0/">документацию</a>, а также на <a href="https://www.phpbb.com/phpBB/viewforum.php?f=46">форуме поддержки phpBB Group</a> и форумах официальной русской поддержки <a href="http://phpbbguru.net">phpBB Guru</a>.',
	...
	'PHP_SETTINGS_EXPLAIN'			=> 'Для установки phpBB <strong>требуется</strong> версия PHP не ниже 5.3.3. Если ниже написано <var>Безопасный режим (Safe mode)</var>, то PHP работает в этом режиме. Это наложит некоторые ограничения на удалённое администрирование и аналогичные функции.',
	...
	'PHP_VERSION_REQD'				=> 'Версия PHP ≥ 5.3.3',
...
$lang = array_merge($lang, array(
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>Прежде чем продолжить процесс обновления, прочтите объявление о выходе последней версии</strong></a>, оно может содержать полезную для вас информацию. В нём также присутствуют ссылки на скачивание и список изменений.</p>
