...
$lang = array_merge($lang, [
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Пароль должен быть длиной от %1$s до %2$s, содержать буквы разных регистров и цифры.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'Должен быть длиной от %1$s до %2$s.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Пароль должен быть длиной от %1$s до %2$s и содержать буквы разных регистров.',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'Пароль должен быть длиной от %1$s до %2$s и содержать буквы разных регистров, цифры и символы.',
	'PASSWORD'					=> 'Пароль',
	'PASSWORD_ACTIVATED'		=> 'Ваш новый пароль активирован.',
	'PASSWORD_UPDATED_IF_EXISTED'	=> 'Если ваша учётная запись существует, то новый пароль был отправлен на адрес email, привязанный к этой учётной записи. Если вы не получили сообщение, возможно, учётная запись заблокирована, деактивирована либо у вас отсутствует доступ к изменению пароля. В этом случае свяжитесь с администратором конференции. Кроме того, убедитесь, что сообщение не было отфильтровано как спам.',
