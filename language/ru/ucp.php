...
$lang = array_merge($lang, array(
	...
	'FIELD_TOO_SHORT'					=> array(
		1	=> 'Значение поля «%2$s» слишком короткое, минимально допустимая длина составляет %1$d символов.',
		2	=> 'Значение поля «%2$s» слишком короткое, минимально допустимая длина составляет %1$d символов.',
	),
	'FIELD_TOO_LONG'					=> array(
		1	=> 'Значение поля «%2$s» слишком длинное, максимально допустимая длина составляет %1$d символов.',
	...
	'FOLDER_MESSAGE_STATUS'		=> array(
		1	=> '%2$d из %1$d сообщений',
		2	=> '%2$d из %1$d сообщений',
	),
	...
	'FOLDER_STATUS_MSG'			=> array(
		1	=> 'Папка заполнена на %3$d%% (%2$d из %1$d сообщений)',
		2	=> 'Папка заполнена на %3$d%% (%2$d из %1$d сообщений)',
	),
	...
	'MOVE_PM_ERROR'					=> array(
		2	=> 'Во время перемещения сообщений в новую папку произошла ошибка, перенесено сообщений: %2d из %1d.',
	),
	...
	'NOT_MOVED_MESSAGES'			=> array(
		1	=> 'Папка с вашими личными сообщениями заполнена. Отложенных сообщений: %d.',
		1	=> 'Папка с вашими личными сообщениями заполнена. Отложенных сообщений: %d.',
	),
	...
	'RULE_REMOVED_MESSAGES'				=> array(
		1	=> 'Фильтрами ЛС было удалено личных сообщений: %d',
		2	=> 'Фильтрами ЛС было удалено личных сообщений: %d',
	),
	...
	'USERNAME_ALPHA_ONLY_EXPLAIN'	=> 'Имя пользователя должно быть от %1$s до %2$s и должно содержать только буквы.',
	'USERNAME_ALPHA_SPACERS_EXPLAIN'=> 'Имя пользователя должно быть от %1$s до %2$s и должно содержать только буквы, пробел или символы -+_[]',
	'USERNAME_ASCII_EXPLAIN'		=> 'Имя пользователя должно быть от %1$s до %2$s и должно содержать только символы ASCII, без специальных символов.',
	'USERNAME_LETTER_NUM_EXPLAIN'	=> 'Имя пользователя должно быть от %1$s до %2$s и должно содержать только буквы или цифры.',
	'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'=> 'Имя пользователя должно быть от %1$s до %2$s и должно содержать только буквы, цифры, пробел или символы -+_[]',
	'USERNAME_CHARS_ANY_EXPLAIN'	=> 'Имя пользователя должно быть от %1$s и до %2$s ',
