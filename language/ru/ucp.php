...
$lang = array_merge($lang, array(
	...
	'UCP_PASSWORD_RESET_DISABLED'	=> 'Функция восстановления пароля была отключена. Если вам нужна помощь для доступа к вашей учетной записи, пожалуйста, свяжитесь с %sАдминистратором конференции%s',
