...
$lang = array_merge($lang, [
	...
	'FOLDER_MESSAGE_STATUS'		=> array(
		1	=> '%2$d сообщение из %1$s',
		2	=> '%2$d сообщения из %1$s',
		3	=> '%2$d сообщений из %1$s',
	),
	...
	'FOLDER_STATUS_MSG'			=> array(
		1	=> 'Папка заполнена на %3$d%% (%2$d сообщение из %1$s)',
		2	=> 'Папка заполнена на %3$d%% (%2$d сообщения из %1$s)',
		3	=> 'Папка заполнена на %3$d%% (%2$d сообщений из %1$s)',
	),
	...
	'EMAIL_NOT_UNIQUE'			=> 'Указанный адрес email используется несколькими пользователями. Необходимо указать имя поьзователя.',
