...
$lang = array_merge($lang, array(
	...
	'UCP_PROFILE_AUTOLOGIN_KEYS'=> 'Управлять ключами входа для функции «Запомнить меня»',

	'UCP_USERGROUPS'			=> 'Группы',
	'UCP_USERGROUPS_MEMBER'		=> 'Участие в группах',
	'UCP_USERGROUPS_MANAGE'		=> 'Управление группами',

	'UCP_PASSWORD_RESET_DISABLED'	=> 'Функция сброса пароля была отключена. Если вам нужна помощь для доступа к вашей учетной записи, пожалуйста, свяжитесь с %sАдминистратором конференции%s',
