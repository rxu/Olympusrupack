...
$lang = array_merge($lang, array(
	...
	'BROWSING_FORUM_GUESTS'	=> array(
		...
		3	=> 'Сейчас этот форум просматривают: %2$s и гости: %1$d',
	),
	'BUTTON_EDIT'			=> 'Правка',
	...
	'REG_USERS_ONLINE'			=> array(
		1	=> 'Сейчас на конференции %1$d зарегистрированный пользователь и %2$s',
		2	=> 'Сейчас на конференции %1$d зарегистрированных пользователя и %2$s',
		3	=> 'Сейчас на конференции %1$d зарегистрированных пользователей и %2$s',
	),
