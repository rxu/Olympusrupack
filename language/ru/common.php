...
$lang = array_merge($lang, [
	...
	'HOURS'							=> 'часов',
	'HOME'							=> 'На главную',
	'HTTP_HANDLER_NOT_FOUND'		=> 'Действие не может быть завершено, поскольку модуль PHP cURL и параметр PHP allow_url_fopen отключены, и другого обработчика HTTP не найдено.',
