...
$lang = array_merge($lang, array(
	...
	'AJAX_ERROR_TEXT_PARSERERROR'	=> 'Что-то пошло не так с запросом, и сервер вернул неверный ответ.',
	'ALLOWED'						=> 'Разрешено',
	'ALL_FILES'						=> 'Все файлы',
	...
	'INSECURE_REDIRECT'			=> 'Попытка перенаправления на потенциально опасный url.',
	'INTERESTS'					=> 'Интересы',
	...
	'POST_BY_AUTHOR'		=> '',
	'POST_BY_FOE'			=> 'Пользователь <strong>%1$s</strong>, находящийся в вашем чёрном списке, написал это сообщение.',
	'POST_DISPLAY'			=> '%1$sПоказать это сообщение%2$s.',
	'POST_DAY'				=> '%.2f сообщений в день',
	'POST_DELETED'			=> 'Удаленное сообщение:',
	'POST_DELETED_BY'		=> '<strong>%2$s</strong> удалил пост автора <strong>%1$s</strong> %3$s.',
	'POST_DELETED_BY_REASON'=> '<strong>%2$s</strong> удалил пост автора <strong>%1$s</strong> %3$s по следующей причине: %4$s',
