...
$lang = array_merge($lang, array(
	...
	'AJAX_ERROR_TEXT_ABORT'			=> 'Запрос пользователя прерван',
	'AJAX_ERROR_TEXT_TIMEOUT'		=> 'Ваш запрос прошел, пожалуйста, попробуйте еще ​​раз.',
	'AJAX_ERROR_TEXT_PARSERERROR'	=> 'Что-то пошло не так с запросом и сервер вернул ошибочный ответ.',
	'ALLOWED'						=> 'Разрешено',
	'ALL_FILES'						=> 'Все файлы',
	...
	'AUTH_PROVIDER_OAUTH_ERROR_INVALID_ENTRY'				=> 'Неверная запись в базе данных.',
	'AUTH_PROVIDER_OAUTH_ERROR_INVALID_SERVICE_TYPE'		=> 'Неверный тип service type provided to OAuth service handler.',
	'AUTH_PROVIDER_OAUTH_ERROR_SERVICE_NOT_CREATED'			=> 'OAuth службы не созданы',
	...
	'BROWSING_FORUM_GUESTS'	=> array(
		1	=> 'Сейчас этот форум просматривают: %2$s и гости: %1$d',
		2	=> 'Сейчас этот форум просматривают: %2$s и гости: %1$d',
	),
	'BUTTON_EDIT'			=> 'Правка',
	...
	'GUEST_USERS_ONLINE'		=> array(
		1	=> 'Сейчас на конференции гостей: %d',
		2	=> 'Сейчас на конференции гостей: %d',
	),
	...
	'HIDDEN_USERS_ONLINE'		=> array(
		1	=> 'скрытых пользователей: %d',
		2	=> 'скрытых пользователей: %d',
	),
	...
	'NEW_PMS'					=> array(
		1	=> 'Новых ЛС: <strong>%d</strong>',
		2	=> 'Новых ЛС: <strong>%d</strong>',
	),
	...
	'NOTIFICATIONS_COUNT'		=> array(
		0	=> '%d уведомлений',
		1	=> 'Уведомлений: <strong>%d</strong>',
		2	=> 'Уведомлений: <strong>%d</strong>',
	),
	...
	'NOTIFICATION_TOPIC'				=> '%1$s создал новую тему «%2$s» в форуме «%3$s».',
	...
	'NO_AVATAR_SELECTED'		=> 'Не выбрана аватара.',
	...
	'ONLINE_USERS_TOTAL'		=> array(
		1	=> 'Всего посетителей: <strong>%1$d</strong> :: %2$s и %3$s',
		2	=> 'Всего посетителей: <strong>%1$d</strong> :: %2$s и %3$s',
	),
	// "... :: x registered, y hidden and z guests"
	'ONLINE_USERS_TOTAL_GUESTS'	=> array(
		1	=> 'Всего посетителей: <strong>%1$d</strong> :: %2$s, %3$s и %4$s',
		2	=> 'Всего посетителей <strong>%1$d</strong> :: %2$s, %3$s и %4$s',
	),
	'OPTIONS'					=> 'Настройки',
	...
	'POST_DAY'				=> '%.2f сообщений в день',
		'POST_DELETED'			=> 'Удаленные сообщения:',
	'POST_DELETED_BY'		=> '<strong>%2$s</strong> удалено сообщение <strong>%1$s</strong> в %3$s.',
	'POST_DELETED_BY_REASON'=> '<strong>%2$s</strong> удалено сообщение <strong>%1$s</strong> в %3$s по следующей причине: %4$s',
	...
	'REG_USERS_ONLINE'			=> array(
		1	=> 'Зарегистрированных пользователей: %1$d и %2$s',
		2	=> 'Зарегистрированных пользователей: %1$d и %2$s',
	),
	'REG_USERS_TOTAL'			=> array(
		1	=> 'зарегистрированных: %d',
		2	=> 'зарегистрированных: %d',
	),
	'REMOVE'					=> 'Удалить',
	...
	'TOTAL_PMS'			=> array(
		1	=> 'Всего личных сообщений: %d ',
		2	=> 'Всего личных сообщений: %d ',
	),
	...
	'UNREAD_PMS'			=> array(
		1	=> 'Непрочитанных сообщений: <strong>%d</strong>',
		2	=> 'Непрочитанных сообщений: <strong>%d</strong>',
	),
	...
	'VIEWED_COUNTS'		=> array(
		0	=> 'Нет просмотров',
		1	=> 'Число просмотров: %d',
		2	=> 'Число просмотров: %d',
	),
	...
	'VIEW_ONLINE_TIMES'			=> array(
		...
		2	=> 'основано на активности пользователей за последние %d минут',
	),
